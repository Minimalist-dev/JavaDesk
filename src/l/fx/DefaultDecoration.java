...
public class DefaultDecoration {
    ...
    private static final Image ERROR_IMAGE = new Image(DefaultDecoration.class.getResource("/i/img/dev/decoration-error.png").toExternalForm());
    private static final Image WARNING_IMAGE = new Image(DefaultDecoration.class.getResource("/i/img/dev/decoration-warning.png").toExternalForm());
    ...
    public static Function<ValidationMessage, Decoration> 
    getFactory() {
        if (factory == null) {
    ...
    public static void 
    setFactory(Function<ValidationMessage, Decoration> factory) {
        DefaultDecoration.factory = factory;
    }
    public static Decoration 
    createStyleClassDecoration(ValidationMessage message) {
        return new StyleClassDecoration("validatorfx-" + message.getSeverity().toString().toLowerCase());
    }
    public static Decoration 
    createGraphicDecoration(ValidationMessage message) {
