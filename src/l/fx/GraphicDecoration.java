...
public class GraphicDecoration implements Decoration {
    ...
    private void 
    withStack(Runnable code, Node target) {
    ...
    private static GraphicDecorationStackPane 
    findDecorationPane(Node node) {
